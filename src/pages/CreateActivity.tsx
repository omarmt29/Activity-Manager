...
const Settings = () => {
  ...
  const handlerInsertImage = async (e) => {
    ...
    if (data) {
      ...
      const InserData = async () => {
        ...
        setposts({ ...post, image_url: imageurl.data.publicUrl })
  ...
  const handlerInsertAcivity = async (e) => {
    e.preventDefault()
  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-270">
        <Breadcrumb pageName="Crear Actividad" />
              ...
              <div className="p-7">
                ...
                <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <input
                      onChange={e => setposts({ ...post, subtitle: e.target.value })}
                      className="w-full rounded border border-stroke bg-gray py-3 pl-3 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="text"
                      name="subtitle"
                      id="subtitle"
                ...
                <div className="w-full sm:w-2/2 mb-5.5">
                  ...
                  <input
                    onChange={e => setposts({ ...post, location: e.target.value })}
                    className="w-full rounded border border-stroke bg-gray py-3 pl-3 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                    type="text"
                    name="subtitle"
                    id="subtitle"
