import RegisterDefaultLayout from '../../layout/RegisterDefaultLayout';
...
const SignUpCompany = () => {
  const [user, setUser] = useState({ image: '', email: '', password: '', re_password: '', id_company: '', company_name: '', name: 'admin', permissions: true, status: true })
  ...
  useEffect(() => {
    ...
    setUser({ ...user, id_company: randomstring })
  ...
  const handlercompany = async () => {
    const { error } = await supabase
      .from('company')
      .insert({ id_company: user.id_company, name: user.company_name, status: user.status, image: user.image })
    if (error) {
      console.log(error)
    }
  }
  ...
  const handlerInsert = async (e) => {
    ...
    if (data) {
      ...
      const InserData = async () => {
        ...
        setUser({ ...user, image: imageurl.data.publicUrl })
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-3 sm:mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Registrar nueva empresa
              </h2>
              <p className='text-meta-1 mb-3 sm:mb-9'>{errorMessage}</p>
              <div className="mb-4">
