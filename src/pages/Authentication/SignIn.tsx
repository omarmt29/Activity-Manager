...
import PublicDefaultLayout from '../../layout/PublicDefaultLayout';
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Inicia sesión y disfruta de las actividades</span>
              <h2 className="mb-4 sm:mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                INICIAR SESIÓN
              </h2>
