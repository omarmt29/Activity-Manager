                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/crear-actividad"
                              className={`group relative text-xs flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('settings') &&
                                'bg-graydark dark:bg-meta-4'
                                }`}
                            >
                              <svg
                          ...
                          <li>
                            ...
                            >
                              <FaRegSquarePlus className='w-5 h-auto text-gray-300' />
                              Publicar Anuncios
                            </NavLink>
                          </li>
                        </ul>
